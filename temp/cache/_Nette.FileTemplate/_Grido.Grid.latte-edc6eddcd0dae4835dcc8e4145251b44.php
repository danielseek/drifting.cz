<?php //netteCache[01]000385a:2:{s:4:"time";s:21:"0.46824100 1364763078";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:63:"C:\Users\Daniel\Documents\GitHub\drifting\libs\Grido\Grid.latte";i:2;i:1364574195;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"0ce871c released on 2012-11-28";}}}?><?php

// source file: C:\Users\Daniel\Documents\GitHub\drifting\libs\Grido\Grid.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'b7p0aot8bo')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block _grid
//
if (!function_exists($_l->blocks['_grid'][] = '_lbe38e363ae4__grid')) { function _lbe38e363ae4__grid($_l, $_args) { extract($_args); $_control->validateControl('grid')
...
// block outerFilter
//
if (!function_exists($_l->blocks['outerFilter'][] = '_lb45563f351d_outerFilter')) { function _lb45563f351d_outerFilter($_l, $_args) { extract($_args)
...
// block table
//
if (!function_exists($_l->blocks['table'][] = '_lbeb23cb3a8b_table')) { function _lbeb23cb3a8b_table($_l, $_args) { extract($_args)
...
// block operations
//
if (!function_exists($_l->blocks['operations'][] = '_lba88123478a_operations')) { function _lba88123478a_operations($_l, $_args) { extract($_args)
...
// block paginator
//
if (!function_exists($_l->blocks['paginator'][] = '_lbf4c0600a77_paginator')) { function _lbf4c0600a77_paginator($_l, $_args) { extract($_args)
...
// block count
//
if (!function_exists($_l->blocks['count'][] = '_lb879cd74058_count')) { function _lb879cd74058_count($_l, $_args) { extract($_args)
?>                <span class="count">
